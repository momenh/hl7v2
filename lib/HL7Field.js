...
class HL7Field {
   ...
   */
  constructor(segment, name, def, customDict, ignoreParsingErrors, encodeHl7DataTypes) {
  ...
  add() {
    ...
    const data = new HL7FieldData(this, this._def, undefined, this._customDict, this._ignoreParsingErrors, this._encodeHl7DataTypes);
