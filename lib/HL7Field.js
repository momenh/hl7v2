...
class HL7Field {
   ...
   */
  constructor(segment, name, def, customDict, ignoreParsingErrors) {
  ...
  add() {
    ...
    const data = new HL7FieldData(this, this._def, undefined, this._customDict, this._ignoreParsingErrors);
